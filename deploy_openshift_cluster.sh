...
# Install OpenShift
ansible-playbook -i inventory/acom_inventory playbooks/openshift-ansible/playbooks/prerequisites.yml;
ansible-playbook -i inventory/acom_inventory playbooks/openshift-ansible/playbooks/deploy_cluster.yml;  
